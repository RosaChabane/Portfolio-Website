  ...
  return (
      <section className='p-20 mb-4 bg-gray-100 flex items-center justify-center'>
        <div className='flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8'>
          <div className='bg-coralTheme flex items-center justify-center clip-circle'>
            <img src={pic} alt="Profile" className="circle-img" />
          </div>
          <div className='max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center'>
            <h1 className='text-center text-4xl mb-5 font-extrabold'>ABOUT ME</h1>
